let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `𝐁𝐋𝐀𝐃𝐄 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍𝐋𝐄 𝐅𝐎𝐋𝐋𝐎𝐖 𝐑𝐄𝐐_\n *𝐋𝐈𝐍𝐊:* https://whatsapp.com/channel/0029VafHAVpICVfdEERr6h2f\n\n ${Config.botname} *WORKS*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `𝐁𝐋𝐀𝐃𝐄 𝐌𝐃 𝐕2 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏\n\n *ʟɪɴᴋ:*https://chat.whatsapp.com/DLniUfYVWR50sbkZDR8tBI \n\n ${Config.botname} *WORKS*`;
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/Bladeh3x/BLADE-MD-V2*");
     }
