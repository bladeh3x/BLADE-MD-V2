...
async function syncdb() {
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /2348059540212|2348069553870/g.test(_0x89b8f6);
      let _0x506b6e = false;
...
async function loadPlugins(_0x31a795) {
  try {
    fs.readdirSync(_0x31a795).forEach(_0x340012 => {
      ...
      } else if ([".js", ".smd", ".pak", ".blade"].includes(path.extname(_0x340012).toLowerCase())) {
        try {
          require(_0x4c0490);
        } catch (_0xf3f8e5) {
...
<title>Bouncing Text - bladeh3x</title>
<style>
  body {
    margin: 0;
    padding: 0;
...
<div class="bounce-text">bladeh3x</div>
