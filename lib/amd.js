      ...
      for (mek of _0x1071af.messages) {
        ...
        events.commands.map(async _0x2dffdb => {
          if (typeof _0x2dffdb.on === "string") {
            ...
            } else if (_0x5979da.text && _0x1d5795 === "text" && /text|txt|true|smd|blade/gi.test(_0x2dffdb.quoted) && _0x5979da.quoted && _0x5979da.quoted.text && _0x3078ae) {
              _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae);
  ...
  _0x5447f8.ev.on("group-participants.update", async _0x33a505 => {
    try {
      ...
      events.commands.map(async _0x497293 => {
        ...
        if (/on|true|main|all|blade|smd/gi.test(_0x497293.group)) {
          try {
            _0x497293.function(_0x1684d7, {
              store: store,
              Void: _0x5447f8
  ...
  _0x5447f8.ev.on("groups.upsert", async _0x6ac529 => {
    try {
      events.commands.map(async _0x591343 => {
        if (/on|true|main|all|blade|smd/gi.test(_0x591343.groupsetting || _0x591343.upsertgroup || _0x591343.groupupsert)) {
          _0x591343.function({
            ..._0x6ac529[0],
            bot: _0x5447f8
          }, {
        ...
        if (Object.keys(_0xd559f7 || {}).length > 0) {
          ...
          for (const _0x5701b6 in _0x22ec5b) {
            try {
              ...
              if (_0x28bc47) {
                let _0x224d22 = _0x5701b6 + (_0x4fcba7[_0x5701b6] && /.js|.smd|.blade/gi.test(_0x4fcba7[_0x5701b6]) ? _0x4fcba7[_0x5701b6] : ".smd");
...
Database:  ${(isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "blade Default")}
\t_VARS_
...
Goodbye Msg: ${global.gdbye}`;
  ...
  _0x5447f8.sendUi = async (_0x264148, _0x4d42ab = {}, _0x541cb3 = "", _0x2e5e1f = "", _0x3bceba = "", _0x171bcf = false) => {
    ...
    try {
      ...
      let _0x237b02;
      if ((_0x171bcf && _0x3bceba && global.style > 0 || !_0x3bceba) && /text|txt|nothing|smd|blade/.test(global.userImages) || _0x2e5e1f == "text") {
        _0x237b02 = {
...
global.toBool = (_0x5f0b1e, _0x23fe95 = false) => /true|yes|ok|act|sure|enable|smd|blade/gi.test(_0x5f0b1e) ? _0x23fe95 ? true : "true" : _0x23fe95 ? false : "false";
async function loadPlugins(_0x31a795) {
  try {
    fs.readdirSync(_0x31a795).forEach(_0x340012 => {
      ...
      } else if ([".js", ".smd", ".blade"].includes(path.extname(_0x340012).toLowerCase())) {
        try {
          require(_0x4c0490);
        } catch (_0xf3f8e5) {
...
<title>Bouncing Text - bladeh4x</title>
<style>
  body {
    margin: 0;
    padding: 0;
...
<div class="bounce-text">bladeh4x</div>
...
app.get("/blade", (_0x2e8c1a, _0x30322c) => _0x30322c.type("html").send(html));
...
app.listen(quickport, () => console.log("blade On  http://localhost:" + quickport + "/  "));
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^blade_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/blade;;;/gi, "").replace(/Astro;;;/gi, "").replace(/bladeh4x;;;/gi, "").trim();
