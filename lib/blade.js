...
yt.getInfo = async (_0x3c2895, _0x49e43c = {}) => {
  try {
    ...
    console.log("./lib/blade/yt.getInfo()\n", _0x39b819.message);
    return {
      status: false
    };
  }
...
yt.download = async (_0x1ea0cb, _0x5c75ae = {
  ...
  try {
    ...
    let _0x3991fc = _0x150898 + "/blade-Md " + _0x1ea0cb + "." + _0x35b4d2;
    ...
    console.log("./lib/blade/yt.dowanload()\n", _0x26244e.message);
    return false;
  }
};
async function sendAnimeReaction(_0x5c448a, _0x46face = "punch", _0x50961f = "", _0x426154 = "") {
  try {
    ...
    return await _0x5c448a.error(_0x1b7c90 + "\nERROR AT : /lib/blade.js/sendAnimeReaction()\n\ncommand: " + _0x46face);
  }
}
async function sendGImages(_0x4a189d, _0x4eee7c, _0x205b7c = caption, _0x1caf0d = "") {
  try {
    ...
    return console.log("./lib/blade.js/sendGImages()\n", _0x36d8e7);
  }
}
...
async function randomeFunfacts(_0x1be35e) {
  try {
    ...
    msg.error(_0x1147af);
    console.log("./lib/blade.js/randomeFunfacts()\n", _0x1147af);
  }
}
async function audioEditor(_0x1ef339, _0x567a0f = "bass", _0x730356 = "") {
  ...
  try {
    ...
    return console.log("./lib/blade.js/audioEditor()\n", _0x48606a);
  }
}
...
async function react(_0x460a9b, _0x131f21, _0x1b76d0 = "") {
  try {
    ...
    console.log("./lib/blade.js/react()\n", _0x102c7a);
  }
}
let note = {
...
async function sendWelcome(_0x50ffa3, _0x3417a5 = "", _0x27d774 = "", _0x3fa550 = "", _0x7317df = "msg", _0x495ef9 = false) {
  try {
    ...
    if (_0x3417a5) {
      ...
      let _0x23df3f = _0x3417a5.replace(/@user|&user/gi, "@" + _0x50ffa3.senderNum).replace(/@name|&name/gi, _0x50ffa3.senderName || "_").replace(/@gname|&gname/gi, "").replace(/@desc|&desc/gi, "").replace(/@count|&count/gi, "1").replace(/@pp|&pp|@gpp|&gpp|@context|&context/g, "").replace(/@time|&time/gi, _0x50ffa3.time).replace(/@date|&date/gi, _0x50ffa3.date).replace(/@bot|&bot/gi, "" + Config.botname).replace(/@owner|&owner/gi, "" + Config.ownername).replace(/@caption|&caption/gi, caption).replace(/@gurl|@website|&gurl|&website|@link|&link/gi, gurl).replace(/@myyt|&myyt/gi, "https://github/Bladeh3x").replace(/@telegram|&telegram/gi, global.telegram || "https://t.me/alex").replace(/@channel|@yt_channel|&channel|&yt_channel/gi, global.YT_PRODUCT || global.YT_CHANNEL || global.YT_PROMOTE || global.YT || "https://github/Bladeh3x").replace(/@runtime|&runtime|@uptime|&uptime/gi, "" + runtime(process.uptime())).trim();
      try {
    ...
    console.log("./lib/blade.js/sendWelcome()\n", _0x30453c);
  }
}
  ...
  try {
    ...
    if (_0x2b48e0 && _0x2b48e0.includes(":")) {
      ...
      if (_0x2d4089.toLowerCase() === "richel" || _0x2d4089 === "1") {
        ...
        _0x30713a = 34;
      } else if (_0x2d4089.toLowerCase() === "blade" || _0x2d4089 === "36") {
        _0x30713a = 35;
    ...
    for (const _0x55bb42 of _0x55b13f) {
      ...
      if (_0x1cf682.length >= 1) {
        ...
        if (_0x243ab6 !== -1) {
          ...
          let _0x192321 = /blade|smd|message|chat/gi.test(_0xef10c6);
          if (!_0x4656bb[_0x192321 ? "blade" : _0xef10c6]) {
            _0x4656bb[_0x192321 ? "blade" : _0xef10c6] = [];
          }
        }
        const _0x26ebaf = _0x1cf682.filter(_0x1fa91c => _0x1fa91c !== "type/" + _0xef10c6 && _0x1fa91c !== "");
        _0xef10c6 = /blade|smd|message|chat/gi.test(_0xef10c6) ? "blade" : _0xef10c6;
        if (_0x26ebaf.length > 0) {
          if (_0x22e9cc.includes(_0xef10c6)) {
            ...
            _0x4656bb[/blade/gi.test(_0xef10c6) ? "blade" : "text"].push(_0x26ebaf.join(" "));
          }
        }
      }
      _0xef10c6 = null;
...
global.mentionblade = process.env.MENTIONSUHAIL || true;
setMention.check = async (_0x373988, _0x3c756b = "", _0xde3e80 = false) => {
  try {
    const _0x313fc4 = _0xde3e80 || _0x373988.mentionedJid.includes(_0x373988.user) || _0x3c756b.includes("@" + _0x373988.user.split("@")[0]) || global.mentionblade && (_0x373988.mentionedJid.includes("@2348059540212@s.whatsapp.net") || _0x373988.mentionedJid.includes("@2348069553870@s.whatsapp.net") || /@2348059540212|@2348069553870/g.test(_0x3c756b));
    if (_0x313fc4) {
      if (global.AstroOfficial !== "yes") {
        return;
      }
