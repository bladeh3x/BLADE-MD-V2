...
exports.groupsg = async (
  ...
  try {
    ...
    let _0x33935f = blade_grop.decodeJid(blade_grop.user.id);
    let _0xbacc49 = _0x33935f.split("@")[0];
    let blade_bot = {
      ...group_sss,
    };
    blade_bot.chat = blade_bot.jid = blade_bot.from = group_sss.id;
    blade_bot.user = blade_bot.sender = Array.isArray(group_sss.participants)
      ? group_sss.participants[0]
      : "xxx";
    blade_bot.name = await blade_grop.getName(blade_bot.user);
    blade_bot.userNum = blade_bot.senderNum = blade_bot.user.split("@")[0];
    blade_bot.time = getTime("h:mm:ss a");
    blade_bot.date = getTime("dddd, MMMM Do YYYY");
    blade_bot.action = blade_bot.status = group_sss.action;
    blade_bot.isCreator = [
      _0xbacc49,
      ...Astro,
      ...global.sudo?.split(","),
      ...
      .includes(blade_bot.user);
    blade_bot.isAstro = [...Astro]
      .map((_0x57d0f3) => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(blade_bot.user);
    blade_bot.fromMe = blade_bot.isAstro
      ? true
      : areJidsSameUser(blade_bot.user, _0x33935f);
    if (blade_bot.action === "remove" && blade_bot.fromMe) {
      return;
    }
    blade_bot.bladeBot = [...Astro]
    ...
    ].includes(blade_bot.chat);
    blade_bot.isGroup = blade_bot.chat.endsWith("@g.us");
    if (blade_bot.isGroup) {
      blade_bot.metadata = await blade_grop.groupMetadata(blade_bot.chat);
      gcs[blade_bot.chat] = blade_bot.metadata;
      blade_bot.admins = blade_bot.metadata.participants.reduce(
        (_0x3d4871, _0xe2eb9e) =>
          (_0xe2eb9e.admin
            ? _0x3d4871.push({
                id: _0xe2eb9e.id,
      ...
      blade_bot.isAdmin = !!blade_bot.admins.find(
        (_0x859f83) => _0x859f83.id === blade_bot.user
      );
      blade_bot.isBotAdmin = !!blade_bot.admins.find(
        (_0x40eef6) => _0x40eef6.id === _0x33935f
      );
    }
    blade_bot.kick = blade_bot.remove = (_0x48f5af = blade_bot.user) =>
      blade_grop.groupParticipantsUpdate(blade_bot.chat, [_0x48f5af], "remove");
    blade_bot.add = (_0x422af3 = blade_bot.user) =>
      blade_grop.groupParticipantsUpdate(blade_bot.chat, [_0x422af3], "add");
    blade_bot.promote = (_0x3d0644 = blade_bot.user) =>
      blade_grop.groupParticipantsUpdate(blade_bot.chat, [_0x3d0644], "promote");
    blade_bot.demote = (_0x37d435 = blade_bot.user) =>
      blade_grop.groupParticipantsUpdate(blade_bot.chat, [_0x37d435], "demote");
    blade_bot.getpp = async (_0x577c8f = blade_bot.user) => {
      try {
        return await blade_grop.profilePictureUrl(_0x577c8f, "image");
      } catch {
        return "https://telegra.ph/file/93f1e7e8a1d7c4486df9e.jpg";
      }
    };
    blade_bot.sendMessage = async (
      _0x5a0f4b = blade_bot.chat,
      _0x2c78a3 = {},
      _0x11fd9c = {
        quoted: "",
      }
    ) => {
      return await blade_grop.sendMessage(_0x5a0f4b, _0x2c78a3, _0x11fd9c);
    };
    blade_bot.sendUi = async (
      _0x107cb3 = blade_bot.chat,
      _0x15a4e0 = {},
      _0x1e19fa = "",
      _0x3b7229 = false,
      _0x289e17 = false,
      ...
      return await blade_grop.sendUi(
        _0x107cb3,
        _0x15a4e0,
        _0x1e19fa,
        _0x3b7229,
    ...
    blade_bot.error = async (
      ...
      if (
        _0x129b35 &&
        Config.errorChat !== "chat" &&
        blade_bot.chat !== blade_bot.botNumber
      ) {
        await blade_grop.sendMessage(blade_bot.jid, {
          text: _0x129b35,
        });
      }
      console.log(_0xfedfc2 ? _0xfedfc2 : _0x386924);
      try {
        return await blade_grop.sendMessage(
          _0x51c1e7,
          {
            text: _0x1ac461,
            ..._0x32def3,
            mentions: [blade_bot.user],
          },
          {
    ...
    blade_bot.send = async (
      ...
      _0xb61629 = "blade",
      _0x919f26 = "",
      _0x3ccfb1 = blade_bot.chat
    ) => {
      _0x3ccfb1 = _0x3ccfb1 ? _0x3ccfb1 : blade_bot.chat;
      switch (_0xb61629.toLowerCase()) {
        ...
        case "react":
          {
            return await blade_grop.sendMessage(_0x3ccfb1, {
              react: {
                text: _0x1def38,
                key: _0x919f26?.key,
              },
        ...
        case "pool":
          {
            return await blade_grop.sendMessage(
              ...
              {
                quoted: _0x919f26,
                messageId: blade_grop.messageId(),
              }
            );
          }
          break;
        ...
        case "sticker":
          {
            let { data: _0x2a29f3, mime: _0x48e80f } = await blade_grop.getFile(
              _0x1def38
            );
            if (_0x48e80f == "image/webp") {
              let _0x500c5a = await writeExifWebp(_0x2a29f3, _0x1bb9da);
              await blade_grop.sendMessage(_0x3ccfb1, {
                sticker: {
                  url: _0x500c5a,
                },
                ..._0x1bb9da,
              ...
              await blade_grop.sendImageAsSticker(
                _0x3ccfb1,
                _0x1def38,
                _0x1bb9da
              );
    ...
    blade_bot.sendPoll = async (
      _0x188344,
      _0x4bb725 = ["option 1", "option 2"],
      _0x34efb6 = 1,
      _0xf53aa9 = "",
      _0x2efafc = blade_bot.jid
    ) => {
      return await blade_bot.send(
        _0x188344,
        {
          values: _0x4bb725,
    ...
    blade_bot.checkBot = (_0x31c33b = blade_bot.sender) =>
      [...Astro, _0xbacc49]
        .map((_0x1e666c) => _0x1e666c.replace(/[^0-9]/g) + "@s.whatsapp.net")
        .includes(_0x31c33b);
    blade_bot.botNumber = _0x33935f;
    blade_bot.bot = _0x56741f ? blade_grop : {};
    if (global.AstroOfficial && global.AstroOfficial === "yes") {
      return blade_bot;
    } else {
      return {};
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("bladeMD");
